...
M.stats = require('neviraide-ui.utils.stats')
M.call = require('neviraide-ui.utils.call')
M.nui = require('neviraide-ui.utils.nui')
...
function M.is_blocking(opts)
  ...
  local reason = opts.blocking and mode.blocking and 'blocking'
    ...
    or #require('neviraide-ui.ui.cmdline').cmdlines > 0 and 'cmdline'
    or nil
...
function M.panic(msg, ...)
  require('neviraide-ui').disable()
  require('neviraide-ui.view.backend.notify').dismiss()
