...
local ConfigViews = require('neviraide-ui.config.views')
local Util = require('neviraide-ui.utils')
local Object = require('nui.object')
local Format = require('neviraide-ui.text.format')
...
function View.get_view(view, opts)
  ...
  local mod = require('neviraide-ui.view.backend.' .. opts.backend)
